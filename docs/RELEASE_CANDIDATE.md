...
Esta revisão não reabre binding, grip, poses, animações, steering, partículas, schema ou snapshots. Ela preserva a baseline da 1.0.18c e corrige somente placeholders e tipografia localizada.
