...
Revisões com sufixo diagnóstico usam `package.json > aspergillum.releaseLabel` no nome do artefato e do relatório. Como o manifest Bedrock aceita apenas `[major, minor, patch]` numérico, as revisões publicadas nunca reutilizam uma trinca. A matriz `1.1.7a/b/c` usa `[1,1,7]..[1,1,9]` e a release 1.1.7 usa `[1,1,10]`; a matriz 1.1.8 usa `[1,1,11]..[1,1,14]`; os diagnósticos 1.1.9a/b/c usam `[1,1,15]..[1,1,17]`; a release 1.1.9 usa `[1,1,18]` e a 1.1.10 usa `[1,1,19]`. A 1.2.0 inicia a linha `[1,2,0]` e a promoção visual 1.2.1 usa `[1,2,1]`. O histórico anterior até 1.1.6 permanece monotônico conforme os manifests e changelog correspondentes.
