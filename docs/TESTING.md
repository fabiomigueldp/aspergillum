...
## Gate visual do pomo e da Mesa do Sacristão — v1.1.4

- [ ] fechar o jogo, remover revisões anteriores e importar somente `Aspergillum-1.1.4.mcaddon` com manifests `[1,1,4]`;
