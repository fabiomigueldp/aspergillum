...
- [CustomForm — Script API estável](https://learn.microsoft.com/en-us/minecraft/creator/scriptapi/minecraft/server-ui/customform?view=minecraft-bedrock-stable): formulário reativo, headers, dropdowns, botões e observáveis usados pela interface da 1.1.0.
