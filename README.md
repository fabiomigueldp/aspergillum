...
> **Versão 1.1.5 RC:** reconstrói os degraus superiores e inferiores da cabeça como superfícies exteriores anulares, eliminando tampas coplanares e centros ocultos que se tornavam instáveis no material `blend` da caldeirinha. A mesma malha é propagada à mão, ao suporte de armadura, à caldeirinha e à Mesa do Sacristão. A personalização continua instantânea e gratuita.
...
2. Abra [`dist/releases/Aspergillum-1.1.5.mcaddon`](dist/releases/Aspergillum-1.1.5.mcaddon) com o Minecraft.
