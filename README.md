...
> **Versão 1.1.4 RC:** reconstrói a extremidade do cabo com placa terminal sólida, colar prateado realmente vazado e faces internas removidas. A transição deixa de conter volumes concorrentes e é propagada igualmente à mão, à caldeirinha e à Mesa do Sacristão. A personalização continua instantânea e gratuita.
...
2. Abra [`dist/releases/Aspergillum-1.1.4.mcaddon`](dist/releases/Aspergillum-1.1.4.mcaddon) com o Minecraft.
