...
assertDiagnosticVariants("water-dither-1.1.8", variants);
...
async function packageStage(stage, variant) {
  ...
  const descriptor = publishArtifact({ projectRoot: root, artifactPath: outputPath, label: variant.label, channel: "diagnostic", family: "water-dither-1.1.8", base: "1.1.7" });
